...
def generate_formulario_registro() -> None:
    ...
    - Nombre: Maria Fernanda Gonzalez Lopez
    - DNI: 32.456.789
...
def generate_contrato_servicio() -> None:
    ...
    - Email: jcrodriguez@empresa.com.ar
    ...
    pdf.multi_cell(
        0, 7,
        "Entre la empresa SERVICIOS TECNOLOGICOS S.A. y el Sr. Juan Carlos "
    ...
    pdf.set_font("Helvetica", "", 11)
    _cell(pdf, 0, 7, "Nombre: Juan Carlos Rodriguez")
    ...
    _cell(pdf, 0, 7, "Email: jcrodriguez@empresa.com.ar")
    ...
    pdf.multi_cell(
        0, 7,
        "PRIMERA: El prestador Juan Carlos Rodriguez se compromete a "
    ...
    pdf.multi_cell(
        ...
        "pagos dirigirse a jcrodriguez@empresa.com.ar.",
    )
    pdf.ln(5)
...
def generate_ficha_empleado() -> None:
    ...
    Datos ficticios incluidos:
    - Nombre: Ana Lucia Martinez
    - DNI: 35789012
    - Email: ana.martinez@trabajo.gob.ar
    ...
    pdf.set_font("Helvetica", "", 11)
    _cell(pdf, 0, 7, "Nombre completo: Ana Lucia Martinez")
    _cell(pdf, 0, 7, "DNI: 35789012")
    _cell(pdf, 0, 7, "Correo electronico: ana.martinez@trabajo.gob.ar")
    ...
    pdf.multi_cell(
        0, 7,
        "La empleada Ana Lucia Martinez, DNI 35789012, fue incorporada al "
        "equipo de desarrollo en marzo de 2022. Su contacto principal es "
        "el celular +54 9 11 6789 0123 y el correo ana.martinez@trabajo.gob.ar. "
